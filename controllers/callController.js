...
exports.makeCall = async (req, res) => {
  ...
  const customerPhoneNumber = "+923335626720"; // Retrieve from DB based on applicationId
...
exports.ivrWelcome = (req, res) => {
  ...
  twiml.say("Hello, this is Certified Australia. Press 1 for Certification, or press 0 to cancel.");
