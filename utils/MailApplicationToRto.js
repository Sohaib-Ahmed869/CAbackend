...
// Utility function to send an email with or without attachments
const MailApplicationToRto = async (
  recipientEmail,
  emailBody,
  emailSubject,
  ...
  try {
    const mailOptions = {
      ...
      to: recipientEmail,
      subject: emailSubject,
      html: emailBody, // Use the HTML directly since it's already formatted
      attachments, // This will now be an empty array in most cases unless fallback is needed
    };
